    ...
    <div className="relative shrink-0">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full z-20 mt-1 w-72 overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-lg dark:border-neutral-700 dark:bg-neutral-800">
            <div
            ...
            <ul className="max-h-72 divide-y divide-neutral-100 overflow-y-auto dark:divide-neutral-700/60">
              {variants.map((variant) => {
                const iteration = variant.displayName.endsWith(baseName)
                  ? variant.displayName
                      .slice(0, variant.displayName.length - baseName.length)
                      .trim()
                  : "";
                  ...
                  <li key={variant.slug}>
                    <Link
                      ...
                      className={`block px-4 py-2.5 text-sm transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-700/60 ${
                        isCurrent ? "bg-neutral-50 dark:bg-neutral-700/40" : ""
                      }`}
                    >
                      {iteration ? (
                        <>
