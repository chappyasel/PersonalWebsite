...
export default function InputForm({ onChange, input }: Props) {
  ...
  const handleDiceInput = useCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      const totalDice = input.totalDice < myCount ? myCount : input.totalDice;
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-2">
        <label className="text-sm font-medium text-foreground">Your dice</label>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-1.5">
            <Button
              ...
              onClick={() =>
                setCurrentBid(
                  currentBid === 1 ? undefined : (currentBid ?? 1) - 1,
                )
              }
            ...
            <Button
              ...
              disabled={
                currentBid !== undefined && currentBid >= input.totalDice
              }
              className="h-8 w-8 shrink-0"
            >
              <PlusIcon className="h-3.5 w-3.5" weight="bold" />
