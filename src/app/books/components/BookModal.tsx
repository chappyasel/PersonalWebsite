            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-background shadow-[0px_10px_50px_10px_rgba(0,0,0,0.3)]">
                  ...
                  <button
                    onClick={onClose}
                    className="absolute right-4 top-4 z-30 rounded-full bg-background/80 p-2 backdrop-blur-sm transition-all hover:bg-background md:right-6 md:top-6"
                    ...
                    >
                      ...
                      <div
                        className={`sticky top-0 z-20 bg-background/95 backdrop-blur-sm transition-all duration-300 lg:hidden ${
                          isScrolled
                            ? "border-b border-muted-foreground/10 py-3 shadow-sm"
                            : "py-6"
                        }`}
                      >
                        <div
                          className={`px-6 ${isScrolled ? "flex items-center gap-4" : "flex flex-col items-center gap-3"}`}
                        >
                          {coverUrl && (
                            <img
                              src={coverUrl}
                          ...
                          {/* Mobile rating */}
                          {!isScrolled && book.rating && (
                            <div className="flex gap-1">
                              {Array.from({ length: 5 }).map((_, i) => (
                                <svg
                                  key={i}
                                  className={`h-4 w-4 ${i < book.rating! ? "fill-yellow-400" : "fill-body/20"}`}
                                  viewBox="0 0 20 20"
                                >
                        ...
                        <div className="space-y-8 p-6 lg:p-10">
                          ...
                          <div className="hidden lg:block">
                            {coverUrl ? (
                              ...
                              <div className="mx-auto flex aspect-[2/3] w-full max-w-[240px] items-center justify-center rounded-xl bg-muted p-6 text-center shadow-[0px_10px_40px_rgba(0,0,0,0.1)]">
                          ...
                          {/* Header info */}
                          <div>
                            <h2 className="mb-3 text-4xl font-bold leading-tight text-foreground">
                              {book.title}
                            </h2>
