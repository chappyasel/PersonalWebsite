...
function DevDiagnosticsHud() {
  ...
  const glassSnapshot = useSyncExternalStore(
          ...
          <details className="stacks-diagnostics-details stacks-diagnostics-experiments">
            ...
            <fieldset className="stacks-diagnostics-section">
              ...
              <label>
                ...
                >
                  <option value="sampled">Sampled scene glass</option>
              ...
              <small>
                Scene glass capture: {glassSnapshot.status} ·{" "}
                {glassSnapshot.reason}
              </small>
            </fieldset>
          </details>
        </div>
