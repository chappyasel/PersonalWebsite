...
const Quotes: React.FC = () => {
  return (
    // PlacardLayer may change the desktop scene colour, but the quotes stay
    // deliberately shadow-free in every context.
    <section className="mt-20 space-y-6 text-sm italic text-foreground/80">
