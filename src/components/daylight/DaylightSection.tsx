  ...
  return (
    ...
    >
      ...
      <div
        data-dl-collapse
        data-open={open}
        className="grid grid-rows-[0fr] transition-[grid-template-rows] [transition-duration:240ms] [transition-timing-function:cubic-bezier(0.22,1,0.36,1)] data-[open=true]:grid-rows-[1fr]"
      >
