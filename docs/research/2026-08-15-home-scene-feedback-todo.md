# Homepage scene feedback TODO — 2026-08-15
...
- [x] Inspect and integrate the requested iPhone and notebook as lying-down Projects props.
- [x] Move the Musings practical-light pool left and forward.
- [x] Redistribute the Musings lower-shelf notes, book, and sailboat.
- [x] Move the Talks microphone to the lower shelf between the plant and right photograph.
- [x] Inspect and integrate the requested harmonica in the microphone's former position.
- [x] Update scene inventory, source/license records, audit evidence, and relevant tests.
- [x] Restore the About upper-shelf composition: portrait at its prior offset, family photo to its right, succulents in the open top-shelf space, and the small portrait leaning backward against the plant at 30°.
- [x] Nudge the About three-book fan slightly right and keep the lower-right photograph fully supported by the shelf.
- [x] Apply page-count/audiobook-length-derived physical thickness to the three About books as well as the Book Notes featured covers.
- [x] Change Book Notes background-book hover from forward tilt to a clean upward lift.
- [x] Give all three Training shakers the restrained shake interaction and tighten their spacing organically.
- [x] Make the Training basketball movable-only so it never opens Weightlifting.
...
- [x] Correct the Projects phone seat, right shaker overhang, About profile seat, and flat-print depth separation.
- [x] Cap under-shelf grass below the solid plank while keeping it visibly unmown.
- [x] Truth the audit ledger against the final basketball, sailboat, mass, interaction, license, and evidence states.
