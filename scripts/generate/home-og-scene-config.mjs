...
// Drive the scene itself at the diagnostics panel's maximum render scale.
// This is separate from the browser device scale used to rasterize the crop.
export const HOME_OG_RESOLUTION_CEILING = 4;
