...
// 1600x288, generated by scripts/generate/sky-clouds.ts
const CLOUDS_URI = `data:image/png;base64,${readFileSync(CLOUDS_PATH).toString("base64")}`;
const CLOUDS_ASPECT = 288 / 1600;
